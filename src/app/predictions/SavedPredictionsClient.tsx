                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <div className="mb-8 p-5 rounded-[2rem] border border-slate-200 bg-white dark:border-white/10 dark:bg-slate-900 shadow-[0_16px_40px_rgba(15,23,42,0.04)]">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                            ...
                            <div className="flex bg-slate-100 dark:bg-white/5 p-1 rounded-xl border border-slate-200/50 dark:border-white/5 self-stretch sm:self-auto">
                              ...
                              <button
                                onClick={() => setCompareMetricMode("attributes")}
                                className={`flex-1 sm:flex-none px-4 py-2 text-xs font-bold rounded-lg transition ${compareMetricMode === "attributes" ? "bg-white dark:bg-white/10 text-cyan-600 dark:text-neon shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
                              >
                                Attributes Profile
                              </button>
                            </div>
                        ...
                        <div className="p-5 rounded-[2rem] border border-slate-200 bg-white dark:border-white/10 dark:bg-slate-900 shadow-[0_16px_40px_rgba(15,23,42,0.04)] overflow-hidden">
                                    ...
                                    <>
                                      ...
                                      <tr className="border-b border-slate-150 dark:border-white/5 hover:bg-slate-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                        ...
                                        {parsedCompareData.map((c) => {
                                          ...
                                          // Remember: Lower defense rating is better (fewer expected conceded goals)
