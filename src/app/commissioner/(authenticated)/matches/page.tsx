...
export default function CommissionerMatchesPage() {
  ...
  const fetchMatches = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/commissioner/matches?${params}`);
  ...
  return (
    <>
      <CommissionerHeader title="Matches" description={`${total} matches synced`} />
