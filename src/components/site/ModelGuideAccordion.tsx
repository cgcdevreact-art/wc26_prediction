          ...
          <AccordionTrigger className="px-5 py-4 hover:no-underline sm:px-8 sm:py-4.5">
            <div className="flex w-full flex-col gap-3 pr-2 text-left sm:pr-4 lg:flex-row lg:items-start lg:justify-between">
              ...
              <Link
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 via-sky-500 to-fuchsia-500 px-4 py-3 text-[11px] font-black uppercase tracking-[0.18em] text-white shadow-[0_10px_25px_rgba(14,165,233,0.22)] transition hover:scale-[1.02] hover:opacity-95 active:scale-[0.98] sm:w-auto sm:shrink-0"
              >
